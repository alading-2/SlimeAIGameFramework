# Projectile Debug Guide

## 日志开关

设置环境变量启用 Projectile 调试日志：
...
1. 确认 DataKey 已注册（调用 ProjectileDataKeys.RegisterAll()）
2. 确认相关 System 已加入 Schedule
3. 检查 capability.json 中的依赖 Capability 是否已启用
4. 查看 Godot smoke 日志中的 Projectile 相关输出
