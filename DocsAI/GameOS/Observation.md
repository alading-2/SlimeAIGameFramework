...
框架侧入口位于 `SlimeAI.GameOS.Observation`：
...
Observation MUST NOT query authoring SQLite during gameplay. It MAY reference sidecars defined by `SlimeAI/DataOS/SnapshotManifest.md`:
