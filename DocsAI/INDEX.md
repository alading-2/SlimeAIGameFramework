...
- 新功能开发入口：`.ai-config/skills/ai/ai-feature-development/SKILL.md`（统一源）、`.codex/skills/ai-feature-development`（工具副本）、`Agent/Protocols/AIFeatureDevelopmentProtocol.md`

## 按任务路由

| 任务 | 先读 | 再读 / 使用 |
| --- | --- | --- |
| 新功能、功能扩展、迁移旧逻辑、框架重构 | `Agent/Protocols/AIFeatureDevelopmentProtocol.md`、`Framework/Principles.md` | `.ai-config/skills/ai/ai-feature-development/SKILL.md` / `.codex/skills/ai-feature-development`、对应 owner skill、必要时 OpenSpec；结束前按功能收尾闸门补测试场景 / artifact / DocsAI |
...
`ai-feature-development` skill 统一源在 `.ai-config/skills/ai/ai-feature-development/`，references 当前固定为 11 个文件：
