...
- Agent 协议：`Workspace/DocsAI/AgentWorkflow/Protocols/`
- 工作区 AI agent 流程总纲：`Workspace/DocsAI/AgentWorkflow/INDEX.md`
- Runtime 测试入口：`Tests/RuntimeTests.md`
- Godot 场景测试入口：`Tests/GodotSceneTesting.md`
- 新功能开发入口：`.ai-config/skills/ai/ai-feature-development/SKILL.md`（统一源）、`.codex/skills/ai-feature-development`（工具副本）、`Workspace/DocsAI/AgentWorkflow/Protocols/AIFeatureDevelopmentProtocol.md`

## 按任务路由

| 任务 | 先读 | 再读 / 使用 |
| --- | --- | --- |
| 新功能、功能扩展、迁移旧逻辑、框架重构 | `Workspace/DocsAI/AgentWorkflow/INDEX.md`、`Workspace/DocsAI/AgentWorkflow/Protocols/AIFeatureDevelopmentProtocol.md`、`Framework/Principles.md` | `.ai-config/skills/ai/ai-feature-development/SKILL.md` / `.codex/skills/ai-feature-development`、对应 owner skill、必要时 OpenSpec；计划阶段先写验收标准，结束前补测试场景 / artifact / DocsAI / retrospective |
| 框架方向、边界、是否该做 | `Framework/Overview.md`、`Framework/Principles.md` | `Workspace/DocsAI/AgentWorkflow/Protocols/FrameworkVsGameBoundary.md` |
...
| Agent 协议 / 长任务 / 完成汇报 | `Workspace/DocsAI/AgentWorkflow/INDEX.md` | `Workspace/DocsAI/AgentWorkflow/Protocols/*.md` |
| OpenSpec change | `Workspace/DocsAI/AgentWorkflow/Protocols/OpenSpecChangeProtocol.md` | `openspec/changes/<change>/` |
...
- AI agent 工作流、协议、角色、hooks/subagent/MCP/git 策略长期知识写入 `Workspace/DocsAI/AgentWorkflow/`。
